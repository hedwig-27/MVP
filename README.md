...
**记录说明**
- 所有数值均为 **NRMSE**。
- 当前记录 0118/0127/0203/0204/0205；对应输出目录分别为 `outputs/primitive_20260118_202629`、`outputs/primitive_20260127_150601`、`outputs/primitive_20260203_142150`、`outputs/primitive_20260204_100636`、`outputs/primitive_20260205_110416`。
...
| 数据集 | MVP（0118） | MVP（0127） | MVP（0203） | MVP（0204） | MVP（0205） | FNO（Single-Family） | FNO（Unified） | UPS-B | UPS-L |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| adv_beta0.4 | 0.010871 | 0.011057 | 0.011469 | 0.011150 | 0.013927 | 0.011 | 0.0130 | 0.0027 | 0.0022 |
| burgers_nu0.001 | 0.044805 | 0.049449 | 0.036011 | 0.036329 | 0.034560 | 0.042 | 0.0501 | 0.0399 | 0.0373 |
| diff_sorp | 0.002099 | 0.002506 | 0.004647 | 0.006824 | 0.003023 | 0.0017 | 0.0041 | 0.0009 | 0.0009 |

**OOD-参数**

| 数据集 | MVP（0118）一步预测 | MVP（0127）一步预测 | MVP（0203）一步预测 | MVP（0204）一步预测 | MVP（0205）一步预测 | UPS-B（0 samples） | FNO（0 samples） |
| --- | --- | --- | --- | --- | --- | --- | --- |
| adv_beta1.0 | 0.433994 | 0.406106 | 0.447640 | 0.330663 | 0.437249 | — | — |
| burgers_nu1 | 0.256437 | 0.229572 | 0.300201 | 0.320175 | 0.398706 | 0.0566 | 1.0342 |

**OOD-方程（reacdiff）**

| 数据集 | MVP（0118）一步预测 | MVP（0127）一步预测 | MVP（0203）一步预测 | MVP（0204）一步预测 | MVP（0205）一步预测 | UPS-B（0 samples） | FNO（0 samples） |
| --- | --- | --- | --- | --- | --- | --- | --- |
| reacdiff_rho1 | 1.396651 | 1.909669 | 0.191827 | 0.260379 | 0.248967 | 0.0557 | 0.1839 |
| reacdiff_rho5 | 0.544398 | 0.466353 | 0.118082 | 0.164833 | 0.200622 | — | — |
| reacdiff_rho10 | 0.728883 | 0.640842 | 0.153330 | 0.155745 | 0.982652 | — | — |
